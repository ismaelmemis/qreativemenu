  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'relative min-h-[38px] rounded-lg border border-stone-200 text-sm transition-shadow  placeholder:text-stone-500/80 text-stone-600/90 focus-within:outline-none focus-within:ring-[1px] focus-within:ring-stone-300 has-[:disabled]:cursor-not-allowed focus-visible:ring-stone-300 has-[:disabled]:opacity-50',
            {
        ...
        >
          <div className="flex flex-wrap gap-1">
            {selected.map((option) => {
              return (
                ...
                >
                  {option.label}
                  <button
                    className="absolute -inset-y-px -end-px flex size-7 items-center justify-center rounded-e-lg border border-transparent p-0 text-muted-foreground/80 outline-0 transition-colors hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-stone/70"
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'flex-1 bg-transparent outline-none placeholder:text-stone-500/80 disabled:cursor-not-allowed',
                {
