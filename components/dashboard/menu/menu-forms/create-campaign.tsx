        ...
        <form className="space-y-5 py-4">
          <div className="space-y-0.5 px-5">
            <Label htmlFor="categoryname" className="text-[15px]">
              Kampanya Adı <span className="text-red-600">*</span>
            </Label>
            <Input id={'categoryname'} type="text" placeholder="Haftasonu Fırsatı..." />
          </div>
          <div className="space-y-0.5 px-5">
            <Label htmlFor="categoryname" className="text-[15px]">
              Kampanya Detayı
            </Label>
            <Textarea placeholder="Kampanya Detayı Girin..." />
          </div>
          <div className="space-y-0.5 px-5">
            <Label htmlFor="categoryname" className="text-[15px]">
              Kampanya Resmi
